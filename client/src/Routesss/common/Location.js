...
class Location extends React.Component {
	constructor(props) {
		...
		this.finishTripFunc = this.finishTripFunc.bind(this);
	...
	addLocation(e) {
		...
		axios
			.post("/trip/" + location.trip_id + "/addlocation", location)
	...
	finishTripFunc() {
		...
		this.props.setTripState(nullTrip);
	}
		...
		return (
			<div className="container" id="location-box">
				<div className="center-block text-center">
					<h2>
						Your trip id is: {this.state.trip.trip_id}
					</h2>
					...
					<ul id="geoData" style={{ listStyleType: "none" }}>
						...
						<li>
							Country: <span id="country" />
						</li>
						<li>
							Latitude: <span id="lat" />
						</li>
						<li>
							Longitude: <span id="lon" />
						</li>
					</ul>
				</div>
			</div>
