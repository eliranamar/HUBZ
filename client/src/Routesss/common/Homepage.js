...
{/*changed text for step 4  */}
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-2"><div className="logowrap"><img className="img-responsive" src="img/logos/airbnb.png" /></div></div>
            <div className="col-md-2"><div className="logowrap"><img className="img-responsive" src="img/logos/fb.png" /></div></div>
            <div className="col-md-2"><div className="logowrap"><img className="img-responsive" src="img/logos/tripadvisor.png" /></div></div>
            <div className="col-md-2"><div className="logowrap"><img className="img-responsive" src="img/logos/snap.png" /></div></div>
            <div className="col-md-2"><div className="logowrap"><img className="img-responsive" src="img/logos/mot.jpg" /></div></div>
            <div className="col-md-2"><div className="logowrap"><img className="img-responsive" src="img/logos/elal.gif" /></div></div>
          </div>
           <div className="row">
            <div className="col-md-2"><div className="logowrap"><img className="img-responsive align-middle" src="img/logos/rome.png" /></div></div>
            <div className="col-md-2"><div className="logowrap"><img className="img-responsive" src="img/logos/vespa.gif" /></div></div>
            <div className="col-md-2"><div className="logowrap"><img className="img-responsive" src="img/logos/sams.gif" /></div></div>
            <div className="col-md-2"><div className="logowrap"><img className="img-responsive" src="img/logos/car2.png" /></div></div>
            <div className="col-md-2"><div className="logowrap"><img className="img-responsive" src="img/logos/hbd.jpg" /></div></div>
            <div className="col-md-2"><div className="logowrap"><img className="img-responsive" src="img/logos/ea.jpeg" /></div></div>
          </div>
          <hr />
        </div>
