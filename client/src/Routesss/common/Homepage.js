	...
	render() {
		return (
			<div id="homepage">
				<div id="home" className="home">
					<div className="text-vcenter">
						...
						<button className="btn btn-success btn-square">
							<Link to="/findtrip">Find Your Next Hub !</Link>
						</button>
					</div>
				</div>
					...
					<div className="container">
						<div className="row">
							...
							<div className="col-sm-6 text-center">
								<h2>What is Hubz ?</h2>
								<p className="lead">
									Ever wanted to travel or find yourself in the middle of a trip
									and not know where to go next? This is where we step in with
									our simple-to-use app, helping you find Hubz, plan your route
									& method of transportation plus all interesting activities
									along the way. <br /> Save Hubz for future reference and share
									with friends!
								</p>
							</div>
						</div>
				...
				<hr />
				<h2 className="text-center"> Our (Future) Partners </h2>
				<hr />
				<div className="container">
					<div className="row">
						<div className="col-md-2 col-sm-4 col-xs-6">
							<div className="logowrap center-block">
								<img
											...
											<div className="col-md-10 col-md-offset-1">
												<div className="row testimonials">
													<div className="col-sm-4">
														<blockquote>
															<p className="clients-words">
																We were lost on our way to battle. HUBZ,
																couldn't have found us a better route!
															</p>
															<span className="clients-name text-primary">
																— Steven Winston<br />
																<span>Boy Genius</span>
															</span>
															<img
													...
													<div className="col-sm-4">
														<blockquote>
															<p className="clients-words">
																HUBZ is the best app of any cohort in our
																history and future!!
															</p>
															<span className="clients-name text-primary">
																— Avi Snir<br />
																<span>CEO Elevation Academy</span>
															</span>
															<img
																className="img-thumbnail img-circle"
																src="img/avi.jpg"
													...
													<div className="col-sm-4">
														<blockquote>
															<p className="clients-words">
																The HUBZ app is a must for all Israelis
																travelling across the globe!
															</p>
															<span className="clients-name text-primary">
																— Yariv Levin<br />
																<span>Minister of Tourism</span>
															</span>
															<img
																className="img-thumbnail img-circle"
																src="img/noscrub.jpg"
					...
					<div className="container">
						<div className="row">
							<div className="col-md-5 col-sm-6 footerleft ">
								...
								<p>
									Hubz is a powerful trip planning service. We enable people to
									create, broaden and share routes with peers.{" "}
								</p>
								<p>
									<i className="fa fa-map-pin" /> WeWork HaZerem 10 | Tel-Aviv |
									Israel{" "}
								</p>
								<p>
									<i className="fa fa-phone" /> 03-674-6999
								</p>
								<p>
									<i className="fa fa-envelope" /> E-mail : contact@hubz.com
								</p>
							</div>
							...
							<div className="col-md-5 col-sm-6 paddingtop-bottom">
								...
								>
									<span className="fa fa-linkedin" /> Hire through Linkedin
								</a>
								<a
								...
								>
									<span className="fa fa-github" /> Clone from github
								</a>
								<a
